...
from src.data.gettickerlist import get_common_tickers
...
df_today  = grouped("2025-09-11")[["T","c","v","vw"]].rename(columns={"T":"ticker","c":"close"})
df_prev   = grouped("2025-09-10")[["T","c"]].rename(columns={"T":"ticker","c":"prev_close"})
