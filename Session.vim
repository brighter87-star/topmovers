...
nnoremap <M-3> :3wincmd w
nnoremap <M-2> :2wincmd w
nnoremap <M-1> :1wincmd w
...
badd +17 getdata.py
badd +1 .env
badd +5 ~/Projects/topmovers/src/utils/config.py
badd +1 src/utils/.env
badd +2 src/data/getdata.py
badd +1 ~/Projects/topmovers/src/data/gettickerlist.py
argglobal
%argdel
edit src/data/getdata.py
...
exe 'vert 3resize ' . ((&columns * 174 + 103) / 206)
argglobal
enew
...
wincmd w
argglobal
balt ~/Projects/topmovers/src/data/gettickerlist.py
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer>  hp <Plug>(GitGutterPreviewHunk)
nmap <buffer>  hu <Plug>(GitGutterUndoHunk)
...
wincmd w
argglobal
if bufexists(fnamemodify("~/Projects/topmovers/src/utils/config.py", ":p")) | buffer ~/Projects/topmovers/src/utils/config.py | else | edit ~/Projects/topmovers/src/utils/config.py | endif
balt src/utils/.env
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer>  hp <Plug>(GitGutterPreviewHunk)
